...
## We cleaned it to get total inflows for each country and graphed this. {.smaller}
```{r}
...
```
<div style="font-size: small; color: black; text-align: left; position: relative;">As you can see, the United States is not the only country with high immigration. Germany peaks in 2015, coinciding with the migrant crisis of that year.</div>
...
## Top/Bottom 5 Wage Differential {.smaller}
