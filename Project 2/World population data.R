...
# Look at the relationship between Area(KmA) and the population of each country in each decade. See if the relationship is direct or inverse.
# One way we can look at the relationship between Area and population is to divide population by area to get a ratio and mutate to the dataframe.
# This is essentially a density calculation, but it's interesting to be able to graph that across all years.
